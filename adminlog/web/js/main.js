...
errorMessage = function(ele) {
    var codeBlocks = ele.getElementsByTagName('pre'),
        callStackItems = ele.getElementsByClassName('call-stack-item');
    ...
    var refreshCallStackItemCode = function(callStackItem) {
        ...
        for (var i = 0, imax = lines.length; i < imax; ++i) {
            ...
            var commonTop = lines[0].top - top;

            lineNumbers[i].style.top = parseInt(lines[i].top - top-commonTop) + 'px';
            ...
            if (parseInt(callStackItem.getAttribute('data-line')) == i) {
                errorLine.style.top = parseInt(lines[i].top - top-commonTop) + 'px';
